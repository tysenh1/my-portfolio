    ...
    theme: {
        extend: {
            ...
            animation: {
                ...
                slideRightMore:
                    "slideRightMore 0.75s ease-in-out 0.6s forwards",
                slideRightLate: "slideRight 0.75s ease-in-out 0.7s forwards",
                slideRightLateLess:
                    "slideRightEvenLess 0.75s ease-in-out 0.7s forwards",
                mainContentInfo: "mainContentInfo 6s ease infinite",
                mainContentInfo1:
                    "mainContentInfo1 0.5s ease infinite forwards",
                mainContentInfo2:
                    "mainContentInfo2 0.5s ease infinite forwards",
                mainContentInfo3:
                    "mainContentInfo3 0.5s ease infinite forwards",
                mainContentInfo4:
                    "mainContentInfo4 0.5s ease infinite forwards",
            },
