...
function Interview({ handleLeftClick, handleRightclick, slideCounter}) {
  ...
  return (
    <div className="pl-64 pr-64 text-white [&_p]:mb-12 [&_p]:mx-12 [&_p]:leading-relaxed">
      ...
      <p>My greatest strength is either my adaptability or my motivation to learn new things. My role at my current job got switched without any notice about a year and a half ago and I went from serving tables in the dining room to taking up room service and doing more advanced cleanup jobs. Instead of complaining about it and trying to stay where I was at, I simply said “ok” and then started on my new tasks and picked everything up very quicky. I did so well for my first time that I ended up sticking with that new role for around 3 months before being moved back to the dining room. </p>
      <p></p>
      <div className="h-[1px] bg-white mx-6 my-6"></div>
