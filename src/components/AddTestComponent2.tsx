...
const AddTestComponent2 = () => {
    ...
    return (
        <button
            onClick={() => {
                const title = `Button 2 in workspace: ${currentWorkspaceId}`
                addComponentToWorkspace(
                    currentWorkspaceId,
                    title,
                    <div className={"bg-white"}>
                       <p>Button 2 in workspace {currentWorkspaceId}!</p>
                    </div>
...
export default AddTestComponent2;
